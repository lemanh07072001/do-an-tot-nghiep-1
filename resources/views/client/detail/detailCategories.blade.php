...
@section('content')
 ...
 <!-- Break -->
        <section class="box-product" data-slug-categories="{{ (!empty($getFirstCategories->slug))?$getFirstCategories->slug:'' }}">
                ...
                <div class="grid md:grid-cols-1 lg:grid-cols-5 grid-cols-1">
                        ...
                        <nav class="flex items-center h-full w-full" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                              <li class="inline-flex items-center">
                                <a href="{{ route('index') }}" class="inline-flex items-center text-md font-medium text-gray-700 hover:text-[#ff5b26] ">
                              ...
                              <li aria-current="page">
                                <div class="flex items-center">
                                  ...
                                  <span class="ms-1 text-md font-medium text-gray-500 md:ms-2">{{ optional($getFirstCategories)->name}}</span>
                                </div>
                              </li>
                            </ol>
                          </nav>
                    ...
                    <div class="col-span-1 mt-3 md:mt-3 lg:mt-0 md:col-span-1 lg:col-span-2 mx-auto lg:m-0">
                        <div class="flex items-center">
                            ...
                            <div>
                                <select id="sort-select" class="block w-full p-2  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#ff5b26] focus:border-[#ff5b26] ">
          ...
          <section class="py-5 ">
            <div class="container max-w-[1170px] mx-auto   items-center h-full px-2.5 pb-6">
              ...
              <div class="w-full mt-6 flex justify-center hidden" id="load-more">
                <button type="button" class="text-white bg-[#ff5b26] hover:bg-[#ff5b26] focus:ring-4 focus:outline-none focus:ring-[#ff5c2688] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center ">
                    Xem thêm
...
@push('js')
 <script>
        var getFirstCategoriesAjax = "{{ route('getFirstCategoriesAjax') }}"

    </script>
    <script src="{{ asset('assets/client/js/getProductCategories.js') }}"></script>
