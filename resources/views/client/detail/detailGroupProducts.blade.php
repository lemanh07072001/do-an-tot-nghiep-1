...
@section('content')
    <!-- Break -->
    <section class="box-product" data-slug-product="{{ !empty($nameGroupProduct->slug) ? $nameGroupProduct->slug : '' }}">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-md font-medium text-gray-500 md:ms-2">{{ optional($nameGroupProduct)->name }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
...
@push('js')
    <script>
        var getGroupProductAjax = "{{ route('getGroupProductAjax') }}"
    </script>
    <script src="{{ asset('assets/client/js/groupProduct.js') }}"></script>
