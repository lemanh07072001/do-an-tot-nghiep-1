                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-md font-medium text-gray-500 md:ms-2">{{ !empty($firstCategories->name) ? $firstCategories->name : $title }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
...
@push('js')
    <script>
        var allProductCategoriesAjax = "{{ route('allProductCategoriesAjax') }}"
    </script>
    <script src="{{ asset('assets/client/js/getAllProducts.js') }}"></script>
