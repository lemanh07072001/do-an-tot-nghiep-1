<x-app-layout>
    ...
    <x-card>
        <form method="POST" action="{{ route('ecommerce_module.categories.store') }}">
            @csrf
            <div class="grid grid-cols-6 gap-4 gap-y-4 ">

                <div class="col-span-6 sm:col-span-3 ">
                    <x-input-label for="name" required>Tên danh mục</x-input-label>
                    <x-text-input name="name" :value="old('name')" id="name" placeholder="Tên danh mục" />
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-select data-get="handleGetOption" name="parent_id">
                        <option value="">Danh mục cha</option>
                        {{ App\Helpers\GetData::showCategoriesSelect($getCategoriesSelect, old('parent_id')) }}
                    </x-select>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-text-input min="0" max="20" type="number" name="order" :value="old('order') ?? 0"
                        id="order" />
                    <x-input-error error="order" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-3" id="imageCategories">
