<x-app-layout>
    @section('title', config('apps.comment.titleIndex'))
        ...
        <div class="w-full mb-1">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <div class="flex items-center" id="handleAdd">
                    ...
                    <div>
                        <a href={{ route('ecommerce_module.comment.create') }}
    ...
    @push('js')
        <script src="{{asset('assets/apps/comment/datatables.js')}}"></script>

        <script>

            var url = '{!! route('ecommerce_module.comment.getData') !!}'
            const columns = [{
                    data: 'id'
                },
                {
