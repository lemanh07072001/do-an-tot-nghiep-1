<x-app-layout>
    ...
    <div class="p-4 max-h-full block sm:flex items-center justify-between   dark:bg-gray-800 ">
        <div class="w-full mb-1">
            <div class="mb-4">
                {{ Breadcrumbs::render('groupProductUpdate',$groupProduct) }}
    ...
    <div>
        <form method="POST" action="{{ route('ecommerce_module.groupProduct.update',$groupProduct) }}">
            @csrf
                ...
                <div class="col-span-8 ">
                    <x-card class="my-0">
                        ...
                        <div class="col-span-6 sm:col-span-3 ">
                            ...
                            <x-text-input name="name" :value="old('name')?? $groupProduct->name" id="name"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <x-text-input name="slug" :value="old('slug')?? $groupProduct->slug" id="slug" />
                        ...
                        <div class="col-span-6 sm:col-span-3 ">
                            ...
                            <x-select data-search="search-status" name="status">
                                @if (\App\Enums\Status::getValues())
                                    ...
                                    <option value="{{ $status }}" @selected(old('status', $groupProduct->status) == $status)>
    ...
    <script>
          ...
          var getGroupProduct = {{ Js::from($getGroupProduct ?? old('idArray')) }};
