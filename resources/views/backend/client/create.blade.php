<x-app-layout>
    ...
    <x-card>
        <form method="POST" action="{{ route('account_module.client.store') }}">
            @csrf
            <div class="grid grid-cols-6 gap-4 gap-y-4">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-text-input name="phone" id="phone" :value="old('phone')" placeholder="Nhập số điện thoại"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-text-input name="address" id="address" :value="old('address')" placeholder="Nhập địa chỉ"
