<x-app-layout>
    @section('title', config('apps.order.titleIndex'))
                    ...
                    <div class="flex pl-2 space-x-1 mr-2">
                        <x-dropdown-form>
                            ...
                            <x-slot:subDropdown class="w-60">
                                <div class="p-1">
                                    <x-input-label required>Hình thức thanh toán</x-input-label>
                                    <x-select data-search="search-method">
                                        <option value="">--Chọn trạng thái--</option>
                                        <option value="cash_on_delivery">Thanh toán khi nhận hàng</option>
                                        <option value="payment_transfer">Thanh toán chuyển khoản</option>
                                    </x-select>
                                </div>

                                <div class="p-1 mt-2">
                                    <x-input-label required>Trạng thái đơn hàng</x-input-label>
    ...
    @include('backend.order.modalOrder')
