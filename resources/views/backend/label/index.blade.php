<x-app-layout>
    @section('title', config('apps.label.titleIndex'))
        ...
        <div class="w-full mb-1">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <div class="flex items-center" id="handleAdd">
                    ...
                    <div>
                        <a href={{ route('ecommerce_module.label.create') }}
    ...
    @push('js')
        <script src="{{asset('assets/apps/label/datatables.js')}}"></script>

        <script>

            var url = '{!! route('ecommerce_module.label.getData') !!}'
            const columns = [{
                    data: 'id'
                },
                {
            ...
            //NOTE - Toggle Status
            var urlToggleStatus = '{!! route('ecommerce_module.label.toggleStatus') !!}'
            toggleStatus(urlToggleStatus, dataTableIndex)

            //NOTE - Delete All
            var urlToggleStatus = '{!! route('ecommerce_module.label.deleteAll') !!}'
            deleteAll(urlToggleStatus, dataTableIndex)

            //NOTE - Delete Row
            var urlToggleStatus = '{!! route('ecommerce_module.label.deleteRow') !!}'
