...
$.extend(true, DataTable.ext.classes, {
    ...
    length: {
        select: "border mx-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500"
    },
    processing: {
    ...
    table: 'dataTable min-w-full text-sm align-middle whitespace-nowrap relative ',
    thead: {
    ...
    tbody: {
        ...
        cell: 'max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400',
