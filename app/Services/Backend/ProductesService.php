    ...
    public function getData($request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($products) {
                ...
                // Kiểm tra quyền cập nhật sản phâme
                if (auth()->user()->can('Cập nhật sản phâme')) {
                    $actions .= '<a href="' . route('ecommerce_module.products.edit', ['products' => $products]) . '"
                ...
                // Kiểm tra quyền xóa sản phâme
                if (auth()->user()->can('Xoá sản phâme')) {
