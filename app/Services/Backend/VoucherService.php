    ...
    public function getData($request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($voucher) {
                return '
                        <a href="' . route('ecommerce_module.voucher.edit', ['voucher' => $voucher]) . '" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-yellow-400 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-400 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
